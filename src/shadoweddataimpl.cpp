...
{
    set_data<unsigned int>({ data }, DataType::UINT);
    return *this;
}
...
void gst::ShadowedDataImpl::set_uchar(std::vector<unsigned char> const & array_data)
{
    set_data<unsigned char>(array_data, DataType::UCHAR_ARRAY);
}

void gst::ShadowedDataImpl::set_int(std::vector<int> const & array_data)
{
    set_data<int>(array_data, DataType::INT_ARRAY);
}

void gst::ShadowedDataImpl::set_uint(std::vector<unsigned int> const & array_data)
{
    set_data<unsigned int>(array_data, DataType::UINT_ARRAY);
}

void gst::ShadowedDataImpl::set_float(std::vector<float> const & array_data)
{
    set_data<float>(array_data, DataType::FLOAT_ARRAY);
}

void gst::ShadowedDataImpl::set_vec2(std::vector<glm::vec2> const & array_data)
{
    set_glm_data<glm::vec2>(array_data, DataType::VEC2_ARRAY, 2);
}

void gst::ShadowedDataImpl::set_vec3(std::vector<glm::vec3> const & array_data)
{
    set_glm_data<glm::vec3>(array_data, DataType::VEC3_ARRAY, 3);
}

void gst::ShadowedDataImpl::set_vec4(std::vector<glm::vec4> const & array_data)
{
    set_glm_data<glm::vec4>(array_data, DataType::VEC4_ARRAY, 4);
}

void gst::ShadowedDataImpl::set_mat3(std::vector<glm::mat3> const & array_data)
{
    set_glm_data<glm::mat3>(array_data, DataType::MAT3_ARRAY, 9);
}

void gst::ShadowedDataImpl::set_mat4(std::vector<glm::mat4> const & array_data)
{
